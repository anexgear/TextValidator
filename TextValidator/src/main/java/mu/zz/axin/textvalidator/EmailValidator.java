...
//    Email validation string takes from:  https://fightingforalostcause.net/content/misc/2006/compare-email-regex.php
    ...
    public boolean validate(String string) {
        return string.matches(EMAIL_VALIDATION_STRING);
    }
}
